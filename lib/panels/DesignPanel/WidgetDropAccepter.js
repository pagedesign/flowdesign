...
var spec = {
  ...
  drop: function drop(props, monitor, component) {
    ...
    if (isWidgetDragging) {
      ...
      console.log(monitor.getInitialClientOffset(), monitor.getInitialSourceClientOffset(), monitor.getClientOffset(), monitor.getDifferenceFromInitialOffset(), monitor.getSourceClientOffset(), 'zzzz');
    ...
    } else {// const dragOffset = monitor.getDifferenceFromInitialOffset();
...
function (_React$Component) {
  ...
  (0, _createClass2["default"])(WidgetDropAccepter, [{
    ...
    value: function render() {
      ...
      }, items.map(this.renderItem), isOver && dragItem.isWidgetDragging ? this.rendrePlaceholder() : null, _react["default"].createElement(_PreviewDragLayer["default"], null)));
    }
  }]);
