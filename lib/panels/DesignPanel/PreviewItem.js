...
var dragSpec = {
  beginDrag: function beginDrag(props, monitor, component) {
    ...
    var item = props.item; // const updatePosition = component.updatePosition.bind(component);
    //由于推拽中实时调用jsPlumb的刷新导致卡顿,使用复制方式进行推拽且不进行实时更新节点连线

    var dragDOM = (0, _reactDom.findDOMNode)(component);
  ...
  endDrag: function endDrag(props, monitor, component) {
    ...
    component.updatePosition(dragOffset.x, dragOffset.y); //移除复制节点

    var nodeDragLayer = dragItem.nodeDragLayer;
